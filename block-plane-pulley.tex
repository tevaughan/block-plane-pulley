...
\newcommand{\doctitle}{Example Solution to a Physics Problem: Blocks, a Pulley,
...
\begin{figure}
   \includegraphics[width=0.95\columnwidth]{accel-001.png}
   \includegraphics[width=0.95\columnwidth]{accel-010.png}
   \includegraphics[width=0.95\columnwidth]{accel-100.png}
